...
const tr = {
  ...
  // Status / VIP Levels
  statusTitle: "Statü",
  currentStatus: "Mevcut Statü",
  toNextLevel: "Seviyesine",
  maxLevelReached: "✦ Maksimum Seviyedesiniz",
  currentLevelBadge: "Şu Anki Seviye",
  depositProgress: "Yatırım İlerlemesi",
  freeLevelDesc: "Herkese açık standart ayrıcalıklar.",
  requireDepositDesc: "Kazanmak için minimum {amount} yatırım gerektirir.",
  remainingDeposit: "Kalan Yatırım",
  withdrawalSpeed: "Çekim Hızı",
  supportType: "Destek Tipi",
  extraProfit: "Ekstra Kazanç",
  depositBonus: "Yatırım Bonusu",
  hours24: "24 Saat",
  hours12: "12 Saat",
  hours2: "2 Saat",
  instantWithdraw: "Anında",
  supportNormal: "Normal Destek",
  supportPriority: "Öncelikli Destek",
  supportVip: "VIP Temsilci",
  supportAdvisor: "Özel Danışman",
  daily: "Günlük",
  kycPending: "Onay Bekliyor",
  kycApprovedSub: "Kimliğiniz onaylandı. Detayları görüntülemek için dokunun.",
  kycReviewSub: "Kimlik belgeleriniz inceleniyor.",
  kycUnverifiedSub: "Para çekme işlemleri için kimlik doğrulaması yapın",
  aboutTitle: "Obyo Option Hakkında",
  aboutDesc1: "Obyo Option, kullanıcıların kripto para, döviz ve emtia piyasalarında ikili opsiyon işlemleri yapmasına olanak tanıyan bir ticaret platformudur.",
  aboutDesc2: "Platform yalnızca eğitim ve simülasyon amaçlıdır.",
  aboutLegalTitle: "Yasal Uyarı",
  aboutLegalDesc: "İkili opsiyonlar yüksek risk içerir. Bu platform yatırım tavsiyesi vermez. Simülasyon sonuçları gerçek piyasa performansını garanti etmez.",
  aboutOk: "Tamam",
};
...
const en: typeof tr = {
  ...
  toNextLevel: "Level Target",
  maxLevelReached: "✦ Maximum Level Reached",
  currentLevelBadge: "Current Level",
  depositProgress: "Deposit Progress",
  freeLevelDesc: "Standard privileges open to all members.",
  requireDepositDesc: "Requires a minimum deposit of {amount} to unlock.",
  remainingDeposit: "Remaining Deposit",
  withdrawalSpeed: "Withdrawal Speed",
  supportType: "Support Tier",
  ...
  supportNormal: "Standard Support",
  supportPriority: "Priority Support",
  supportVip: "VIP Specialist",
  supportAdvisor: "Personal Advisor",
  daily: "Daily",
  kycPending: "Pending Review",
  kycApprovedSub: "Your identity is verified. Tap to view details.",
  kycReviewSub: "Your documents are currently under review.",
  kycUnverifiedSub: "Complete identity verification to enable withdrawals",
  aboutTitle: "About Obyo Option",
  aboutDesc1: "Obyo Option is a trading platform that allows users to trade binary options across crypto, forex, and commodities.",
  aboutDesc2: "The platform is strictly for educational and simulation purposes.",
  aboutLegalTitle: "Risk Warning",
  aboutLegalDesc: "Binary options involve high risk. This platform does not provide investment advice. Simulation results do not guarantee real market performance.",
  aboutOk: "OK",
};
...
const de: typeof tr = {
  ...
  toNextLevel: "Stufenziel",
  maxLevelReached: "✦ Maximale Stufe erreicht",
  currentLevelBadge: "Aktuelle Stufe",
  depositProgress: "Einzahlungsfortschritt",
  freeLevelDesc: "Standard-Privilegien für alle Mitglieder.",
  requireDepositDesc: "Erfordert eine Mindesteinzahlung von {amount}.",
  remainingDeposit: "Verbleibende Einzahlung",
  withdrawalSpeed: "Auszahlungsdauer",
  supportType: "Support-Kategorie",
  extraProfit: "Zusätzlicher Gewinn",
  depositBonus: "Einzahlungsbonus",
  hours24: "24 Stunden",
  hours12: "12 Stunden",
  hours2: "2 Stunden",
  instantWithdraw: "Sofort",
  supportNormal: "Standard-Support",
  supportPriority: "Prioritäts-Support",
  supportVip: "VIP-Spezialist",
  supportAdvisor: "Persönlicher Berater",
  daily: "Täglich",
  kycPending: "Wartet auf Prüfung",
  kycApprovedSub: "Ihre Identität wurde verifiziert. Tippen Sie für Details.",
  kycReviewSub: "Ihre Dokumente werden derzeit geprüft.",
  kycUnverifiedSub: "Schließen Sie die Identitätsprüfung ab, um Auszahlungen freizuschalten",
  aboutTitle: "Über Obyo Option",
  aboutDesc1: "Obyo Option ist eine Handelsplattform, mit der Sie binäre Optionen auf Krypto-, Devisen- und Rohstoffmärkten handeln können.",
  aboutDesc2: "Die Plattform dient ausschließlich zu Bildungs- und Simulationszwecken.",
  aboutLegalTitle: "Risikohinweis",
  aboutLegalDesc: "Binäre Optionen bergen erhebliche Risiken. Diese Plattform stellt keine Anlageberatung dar. Simulationsergebnisse garantieren keine reale Marktentwicklung.",
  aboutOk: "OK",
};
